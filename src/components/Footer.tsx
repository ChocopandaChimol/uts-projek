...
const Footer = () => {
  return (
    <div className="bg-[rgb(28,28,51)] text-white py-12">
      <div className="max-w-screen-xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <div className="flex flex-col mb-4 transition-transform transform hover:scale-105">
          <img
            src="/Logo.png"
            alt="Logo"
        ...
        <div className="flex flex-col mb-4 transition-transform transform hover:scale-105">
          ...
          <div className="flex items-center">
            <input
              type="email"
              placeholder="Email"
              className="w-full p-2 rounded-l-md border border-gray-300 focus:outline-none focus:border-blue-500 text-black transition-colors"
            />
